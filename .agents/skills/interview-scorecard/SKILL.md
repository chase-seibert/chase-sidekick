...
Draft a concise interview scorecard from pasted interview notes, nearby calendar context, and `memory/miclog.txt` generated by [miclog](https://github.com/chase-seibert/miclog).
